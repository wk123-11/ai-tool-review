...
OpenAI 在2025年底推出的 GPT-4o Transcribe 系列彻底改写了语音识别的精度标准。GPT-4o Transcribe 在多个基准测试中 Word Error Rate（WER）降至3.8%，而 GPT-4o Mini Transcribe 定价仅为 Whisper 的一半，性价比突出。
